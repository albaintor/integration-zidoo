...
class SetupFlow:
    ...
    def __init__(self, api: IntegrationAPI):
        ...
        self._reconfigured_device: ConfigDevice | None = None
            ...
            case "configure":
                ...
                return RequestUserInput(
                    ...
                    [
                        ...
                        {
                            "field": {"text": {"value": self._reconfigured_device.net_mac_address}},
                            "id": "net_mac_address",
                            "label": {"en": "Wired Mac address", "fr": "Adresse Mac filaire"},
                        },
                        {
                            "field": {"text": {"value": self._reconfigured_device.wifi_mac_address}},
                            "id": "wifi_mac_address",
                        ...
                        },
                        {
                            ...
                            "field": {"checkbox": {"value": self._reconfigured_device.always_on}},
                        },
                        {
                            "id": "refresh_interval",
                            "label": {
                            ...
                            "field": {
                                "number": {
                                    "value": self._reconfigured_device.refresh_interval,
                                    "min": 5,
                                    "max": 120,
                                    "steps": 1,
                                    "decimals": 0,
    ...
    async def handle_device_choice(self, msg: UserDataResponse) -> SetupComplete | SetupError:
        """
        Process user data response in a setup process.
    ...
    async def _handle_device_reconfigure(self, msg: UserDataResponse) -> SetupComplete | SetupError:
        ...
        self._reconfigured_device.net_mac_address = net_mac_address
