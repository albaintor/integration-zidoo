...
from const import ZidooSensors
...
class ZidooSensor(ZidooEntity, Sensor):
    """Representation of a Kodi Sensor entity."""

    ENTITY_NAME = "sensor"
    SENSOR_NAME: ZidooSensors
...
class ZidooAudioStream(ZidooSensor):
    """Current audio stream sensor entity."""

    ENTITY_NAME = "audio_stream"
    SENSOR_NAME = ZidooSensors.SENSOR_AUDIO_STREAM
...
class ZidooSubtitleStream(ZidooSensor):
    """Current subtitle stream sensor entity."""

    ENTITY_NAME = "subtitle_stream"
    SENSOR_NAME = ZidooSensors.SENSOR_SUBTITLE_STREAM
...
#     SENSOR_NAME = ZidooSensors.SENSOR_VOLUME
#
#     def __init__(self, config_device: ConfigDevice, device: zidooaio.ZidooClient):
#         """Initialize the class."""
#         entity_id = f"{create_entity_id(config_device.id, EntityTypes.SENSOR)}.{self.ENTITY_NAME}"
...
#
#
# class KodiSensorMuted(ZidooSensor):
#     """Current mute state sensor entity."""
#
#     ENTITY_NAME = "sensor_muted"
#     SENSOR_NAME = ZidooSensors.SENSOR_VOLUME_MUTED
#
#     def __init__(self, config_device: ConfigDevice, device: zidooaio.ZidooClient):
#         """Initialize the class."""
#         entity_id = f"{create_entity_id(config_device.id, EntityTypes.SENSOR)}.{self.ENTITY_NAME}"
